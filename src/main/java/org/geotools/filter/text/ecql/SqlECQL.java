...
public class SqlECQL {
    ...
    public static Filter toFilter(final String ecqlPredicate)
        throws CQLException {
        Filter filter = SqlECQL.toFilter(ecqlPredicate, null);
    ...
    public static Filter toFilter(final String ecqlPredicate, final FilterFactory filterFactory)
        ...
        SqlECQLCompilerFactory compilerFactory = new SqlECQLCompilerFactory();
    ...
    public static final void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                List<Filter> filters = SqlECQL.toFilterList(line);
